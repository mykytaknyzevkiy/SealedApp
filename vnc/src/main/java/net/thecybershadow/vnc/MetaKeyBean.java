...
class MetaKeyBean extends AbstractMetaKeyBean implements Comparable<MetaKeyBean> {
	...
	/* (non-Javadoc)
	 * @see net.thecybershadow.vnc.AbstractMetaKeyBean#getKeyDesc()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.thecybershadow.vnc.AbstractMetaKeyBean#setKeyDesc(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.thecybershadow.vnc.AbstractMetaKeyBean#setKeySym(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.thecybershadow.vnc.AbstractMetaKeyBean#setMetaFlags(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.thecybershadow.vnc.AbstractMetaKeyBean#setMouseButtons(int)
	 */
	@Override
